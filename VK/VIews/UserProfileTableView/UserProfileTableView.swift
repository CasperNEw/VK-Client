...
class UserProfileTableView: UITableViewController {
    ...
    var dataUserSpecial = [AdvancedUserVK]()
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "UserProfileInfoCell", bundle: nil), forCellReuseIdentifier: "UserProfileInfo")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let infoCell = tableView.dequeueReusableCell(withIdentifier: "UserProfileInfo", for: indexPath) as? UserProfileInfoCell else { return UITableViewCell() }
        ...
        infoCell.photoCollection.register(UINib(nibName: "UserProfileCollectionCell", bundle: nil), forCellWithReuseIdentifier: "UserProfileCollection")
...
extension UserProfileTableView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "UserProfileCollection", for: indexPath) as? UserProfileCollectionCell else { return UICollectionViewCell() }
